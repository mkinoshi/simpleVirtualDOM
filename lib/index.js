...
const needChange = (oldElement, newElement) => {
  console.log(oldElement.props, newElement.props);
  // when old element is string
  if (typeof oldElement === 'string') {
    return oldElement !== newElement;
  }
  return oldElement.type !== newElement.type || typeof oldElement !== typeof newElement || compareProps(oldElement.props, newElement.props);
};
